...
let monsterName : string[] = ["Anglerfisch", "Specht", "Hund", "Atze", "Uwe", "Pferd"]; // length = 3, da 3 Einträge. Von 0-2.
let suffix : string[] = [" des Zauberwaldes", " aus der Ozonschicht", " der Kummerhölle", " mit AIDS", " mit Komplexen", " der Unbesiegbarkeit"]; // length = 6, da hier 6 Einträge sind. Von 0-5.

let picScr : string[] = ["imgs/berle.jpg", "imgs/mietz.jpg", "imgs/hund.jpg", "imgs/ellie.jpg", "imgs/pferd.jpg", "imgs/wilma.jpg", "imgs/monter.jpg", "imgs/katze.jpg"]
...
let monsterPofB : string[] = ["Nordpol", "Mond", "Mars", "china", "Kambodia", "unknown", "Russland"]
...
function monsterGenerateHTML()
{
    ...
    monsterImg.setAttribute("src", monsterArray[monsterArray.length - 1].monsterPic);                 // Der Pfad für das Bild muss über setAttribute festgelegt werden. Der Bildpfad kann natürlich auch anders aussehen.
    monsterImg.setAttribute("alt", "Schreckliches Monster");            // Das alt für das Bild wird hier festgelegt.
    holdingDiv.appendChild(monsterImg);                                 // Füge das Bild zu dem holding-div hinzu (<div>, welche ein paar Zeilen zuvor erstellt worden ist)

    let monsterP : HTMLElement = document.createElement("p");
    monsterP.innerHTML = monsterArray[monsterArray.length -1].monsterPoB;
...
function generateMonsterPic() : string {
    let rngNumber : number = getRNGNumber(picScr.length);                 // Diese Funktion gibt einen zufälligen Bild-Pfad zurück.
